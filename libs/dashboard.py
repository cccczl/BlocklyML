...
def dashboard_app(df, dash_app, plotly_config):
                                ...
                                children=[
                                    dcc.Tab(
                                        ...
                                        children=[
                                            ...
                                            html.Div(
                                                id="input-scatter-not-mandatory",
                                                style=not_mandatory_div_style,
                                                children=[
                                                    dcc.Dropdown(
                                                        id="input-color-scatter",
                                                        options=dropdowns,
                                                        placeholder="Enter Color axis Value",
                                                    ),
                                                    dcc.Dropdown(
                                                        id="input-size-scatter",
                                                        options=dropdowns,
                                                        placeholder="Enter Size axis Value",
                                                    ),
                                                    dcc.Input(
                                                        id="input-other-scatter",
                                        ...
                                        children=[
                                            ...
                                            html.Div(
                                                ...
                                                children=[
                                                    ...
                                                    dcc.Dropdown(
                                                        id="input-barmode-bar",
                                                        options=barmode,
                                                        placeholder="Enter BarMode",
                                                    ),
                                                    dcc.Input(
                                                        id="input-other-bar",
                                                        placeholder="Enter Other parameters",
                                    ...
                                    dcc.Tab(
                                        ...
                                        children=[
                                            ...
                                            html.Div(
                                                id="input-pie-not-mandatory",
                                                style=not_mandatory_div_style,
                                                children=[
                                                    dcc.Dropdown(
                                                        id="input-names-pie",
                                                        options=dropdowns,
                                                        placeholder="Enter names Value",
                                                    ),
                                                    dcc.Input(
                                                        id="input-other-pie",
                                                        placeholder="Enter Other parameters",
                                    ...
                                    dcc.Tab(
                                        ...
                                        children=[
                                            html.Div(
                                                id="input-tree-mandatory",
                                                style=mandatory_div_style,
                                                children=[
                                                    dcc.Dropdown(
                                                        id="input-x-tree",
                                                        options=dropdowns,
                                                        placeholder="Enter Tree Path",
                                                        multi=True,
                                                    ),
                                                    dcc.Dropdown(
                                                        id="input-value-tree",
                                    ...
                                    dcc.Tab(
                                        ...
                                        children=[
                                            ...
                                            html.Div(
                                                id="input-sunburst-not-mandatory",
                                                style=not_mandatory_div_style,
                                                children=[
                                                    dcc.Dropdown(
                                                        id="input-color-sun",
                                ...
                                children=[
                                    ...
                                    dcc.Tab(
                                        ...
                                        children=[
                                            ...
                                            html.Div(
                                                id="input-heatmap-not-mandatory",
                                                style=not_mandatory_div_style,
                                                children=[
                                                    dcc.Dropdown(
                                                        id="input-color-heat",
                                    ...
                                    dcc.Tab(
                                        ...
                                        children=[
                                            ...
                                            html.Div(
                                                id="input-violoin-not-mandatory",
                                                style=not_mandatory_div_style,
                                                children=[
                                                    dcc.Dropdown(
                                                        id="input-color-violin",
                                                        options=dropdowns,
                                                        placeholder="Enter Color Value",
                                                    ),
                                                    dcc.Input(
                                                        id="input-other-violin",
                                                        placeholder="Enter Other parameters",
                                                    ),
                                                    html.P(
                                                        "* Optional Inputs",
                                    ...
                                    dcc.Tab(
                                        ...
                                        children=[
                                            html.Div(
                                                ...
                                                children=[
                                                    dcc.Dropdown(
                                                        id="input-x-regscatter",
                                                        options=dropdowns,
                                                        placeholder="Enter X axis Value",
                                                    ),
                                                    dcc.Dropdown(
                                                        id="input-y-regscatter",
                                                        options=dropdowns,
                                                        placeholder="Enter Y axis Value",
                                                    ),
                                                    dcc.Dropdown(
                                            ...
                                            html.Div(
                                                ...
                                                children=[
                                                    dcc.Dropdown(
                                                        id="input-color-regscatter",
                                                        options=dropdowns,
                                                        placeholder="Enter Color axis Value",
                                                    ),
                                                    dcc.Dropdown(
                                                        id="input-size-regscatter",
                                                        options=dropdowns,
                                                        placeholder="Enter Size axis Value",
                                                    ),
                                                    dcc.Input(
                                                        id="input-other-regscatter",
                                                        placeholder="Enter Other parameters",
                                                    ),
                                                    html.P(
                                                        "* Optional Inputs",
                    ...
                    dcc.Tab(
                        ...
                        children=[
                                    ...
                                    html.Code(
                                        ...
                                        children=[
                                            dcc.Textarea(
                                                ...
                                                placeholder="use variable 'df' as datta frame and export plotly figure to variable 'fig'",
                                                style={
                                                    " marginLeft": "1%",
                                                    "width": "98%",
                                                    " marginRight": "1%",
                            ...
                            dcc.Loading(
                                ...
                                type="default",
                                children=html.Div(
                                    id="output-state-custom", children=[], style=left_indent_style
                                ),
                            ),
                        ],
                    ),
    ...
    @dash_app.callback(
        Output("output-state-scatter", "children"),
    ...
    def update_barplot(n_clicks, input1, input2, input3, input4, input5):
        if strNoneConvert(input1) in df.columns and strNoneConvert(input2) in df.columns:
            ...
            return dcc.Graph(id="graph-bar-tabs", figure=fig)

        return "Fill the required fields and click on 'Submit' to generate the graph you want!!"

    @dash_app.callback(
        Output("output-state-pie", "children"),
    ...
    @dash_app.callback(
        Output("output-state-box", "children"),
    ...
    def update_barplot(n_clicks, input1, input2, input3, input4):
        if strNoneConvert(input1) in df.columns and strNoneConvert(input2) in df.columns:
            ...
            return dcc.Graph(id="graph-box-tabs", figure=fig)
    ...
    def update_regscatterplot(n_clicks, input1, input2, input3, input4, input5, input6):
        if strNoneConvert(input1) in df.columns and strNoneConvert(input2) in df.columns:
            ...
            fig = px.scatter(df, **input_parametes)
            return dcc.Graph(id="graph-regscatter-tabs", figure=fig)

        return "Fill the required fields and click on 'Submit' to generate the graph you want!!"

    @dash_app.callback(
        Output("output-state-map-line", "children"),
    ...
    def update_maplineplot(n_clicks, input1, input2, input3):
        if strNoneConvert(input1) in df.columns:
            ...
            input_parametes = {
                "locations": strNoneConvert(input1),
                "color": strNoneConvert(input2),
                "template": plot_theme,
                "color_continuous_scale": plotly_color_continuous_scale,
            }
            ...
            return dcc.Graph(id="graph-map-line-tabs", figure=fig)
        return "Fill the required fields and click on 'Submit' to generate the graph you want!!"

    @dash_app.callback(
        Output("output-state-map-scatter", "children"),
    ...
    @dash_app.callback(
        Output("output-state-map-density", "children"),
    ...
    def update_mapdensityplot(n_clicks, input1, input2, input3, input4, input5):
        if strNoneConvert(input1) in df.columns and strNoneConvert(input2) in df.columns:
            ...
            return dcc.Graph(id="graph-map-density-tabs", figure=fig)
        return "Fill the required fields and click on 'Submit' to generate the graph you want!!"

    @dash_app.callback(
        Output("output-state-candlestick", "children"),
    ...
    def update_candlestick(n_clicks, input1, input2, input3, input4, input5, input6):
        if (
            strNoneConvert(input1) in df.columns
            and strNoneConvert(input2) in df.columns
            and strNoneConvert(input3) in df.columns
            and strNoneConvert(input4) in df.columns
            and strNoneConvert(input5) in df.columns
        ):

            input_parametes = {
                "x": df[strNoneConvert(input1)],
            ...
            return dcc.Graph(id="graph-candlestick-tabs", figure=fig)
        return "Fill the required fields and click on 'Submit' to generate the graph you want!!"

    @dash_app.callback(
        Output("output-state-ohlc", "children"),
    ...
    def update_ohlcstick(n_clicks, input1, input2, input3, input4, input5, input6):
        if (
            ...
            return dcc.Graph(id="graph-ohlc-tabs", figure=fig)
        return "Fill the required fields and click on 'Submit' to generate the graph you want!!"

    @dash_app.callback(
        Output("output-state-ternary", "children"),
    ...
    def update_ternaryplot(n_clicks, input1, input2, input3, input4, input5, input6):
        if (
            ...
            return dcc.Graph(id="graph-ternary-tabs", figure=fig)
        return "Fill the required fields and click on 'Submit' to generate the graph you want!!"

    @dash_app.callback(
        Output("output-state-polar", "children"),
    ...
    @dash_app.callback(
        Output("output-state-streamtube", "children"),
    ...
    def update_streamtubeplot(n_clicks, input1, input2, input3, input4, input5, input6, input7):
        if (
            ...
            and strNoneConvert(input4) in df.columns
            and strNoneConvert(input5) in df.columns
            and strNoneConvert(input6) in df.columns
        ):
            ...
            return dcc.Graph(id="graph-streamtube-tabs", figure=fig)
        return "Fill the required fields and click on 'Submit' to generate the graph you want!!"

    @dash_app.callback(
        Output("output-state-custom", "children"),
    ...
    def update_customplot(n_clicks, input1):
        if not input1 is None:
            ...
            return dcc.Graph(id="graph-custom-code-tabs", figure=_locals["fig"])
        return "Fill the required fields and click on 'Submit' to generate the graph you want!!"
